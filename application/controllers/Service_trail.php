...
class Service_trail extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['title'] = 'Service Trail';

        $data['trans_type']=$this->Trans_type_services_model->get_list();
        $data['trans_key']=$this->Trans_key_services_model->get_list();
